...
import {
  ...
  ChevronRight, FileText, Truck, Plus,
} from 'lucide-react';
...
export default function ClientDashboard() {
  ...
  const recentShipments = stats?.recent_shipments || [];
  const recentInvoices = stats?.recent_invoices || [];
  const lastShipmentDate = recentShipments[0]?.created_at;
        ...
        <Card className="lg:col-span-2 overflow-hidden">
          ...
          >
            <div>
              ...
              <p style={{ fontSize: 12, color: 'var(--color-steel)', marginTop: 4 }}>
                Les 5 dernieres expeditions de votre compte.
              </p>
            </div>
            <Link
          ...
          {loading ? (
            ...
            <EmptyState
              ...
              description="Vous pouvez demander un suivi ou suivre l'etat de vos colis depuis ce tableau de bord."
            />
          ) : (
      ...
      <Card className="overflow-hidden">
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 12, color: 'var(--color-steel)', marginTop: 4 }}>
              Les dernieres factures emises a votre encontre.
            </p>
          </div>
          <Link
            to="/client/mes-factures"
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Aucune facture n'a ete emise a votre encontre pour le moment."
          />
        ) : (
          <div className="overflow-x-auto">
            <table className="table-clean">
              <thead>
                ...
                <tbody>
                  ...
                  <tr key={inv.id}>
                    <td className="font-mono-data">
                      <Link
                        to={`/client/mes-factures?focus=${inv.id}`}
                        style={{ color: 'var(--color-primary)', fontWeight: 500 }}
                      >
...
function QuickActionCard({ to, icon: Icon, title, description, accent }) {
  ...
  return (
    <Link to={to} className="block" style={{ textDecoration: 'none' }}>
      <Card className="p-4 transition-all hover:shadow-md" style={{ cursor: 'pointer' }}>
