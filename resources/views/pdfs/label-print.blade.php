...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .label-block-content .name { font-weight: bold; font-size: 11pt; }
        .label-block-content .company { font-size: 9pt; color: #333; }
        .label-block-content .address { font-size: 9pt; color: #333; }
        .label-block-content .city { font-size: 9pt; font-weight: bold; margin-top: 1px; }
        ...
        .barcode-area img { max-width: 100%; height: 14mm; }
        .barcode-number {
            font-size: 10pt;
            font-weight: bold;
            letter-spacing: 2px;
        ...
        .package-info-item .label-value { font-size: 11pt; font-weight: bold; color: #000; }
        .package-info-item .label-value-large { font-size: 16pt; font-weight: 900; color: #000; }
        ...
        .contents strong { color: #000; font-weight: bold; }
        ...
        .tracking-ref { font-size: 8pt; color: #000; margin-top: 2px; }
        .site-web {
            font-size: 9pt;
            font-weight: 700;
            color: #000;
...
<body>
    @php
        ...
        $reference = $shipment->client->account_number ?? ($shipment->quote_id ? 'DIV-' . $shipment->quote_id : $shipment->shipping_number);
            ...
            <div class="label-header">
                <div class="label-header-row">
                    ...
                    <div class="logo-area">
                        ...
                        @else
                            <img src="{{ public_path('logos/logo_noir.jpg') }}" class="logo-img" alt="Logo">
                        @endif
            ...
            <div class="label-body">
                <div class="label-row-flex">
                    <div class="label-block col-wide">
                        ...
                        <div class="label-block-content">
                            ...
                            @if($shipment->client)<div style="font-size:7pt; color:#000;">{{ $shipment->client->account_number }}</div>@endif
                ...
                <div class="label-row-flex">
                    ...
                    <div class="label-block col-narrow">
                        ...
                        <div class="label-block-content">
                            <div style="font-size:9pt; font-weight:bold;">{{ $shipment->recipient_phone ?: 'N/A' }}</div>
                        </div>
                    </div>
                </div>
